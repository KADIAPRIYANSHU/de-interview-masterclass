...
| `data/scenarios.js` | 13-module Real-Time DE Scenarios dataset |
...
└── data/
    ...
    └── scenarios.js        # 13 Real-Time Scenarios modules
```

**Total Curriculum:** 107 detailed learning modules across 9 technology domains.
