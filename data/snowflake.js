window.snowflakeLessons = {
    ...
    "duration": "🕒 15 min read",
    "difficulty": "Advanced",
    "theory": "\n            <h3>Stages Overview</h3>\n            <p>An External Stage points to cloud storage (S3, Azure Blob, GCS) where source files reside.</p>\n            <h3>Storage Integration Objects</h3>\n            <p>Instead of hardcoding AWS IAM access keys or SAS tokens inside stage SQL (security risk), you create a <strong>Storage Integration</strong> object. This establishes a secure trust relationship between your Snowflake account tenant and the cloud provider using IAM roles and trust policies.</p>\n        ",
    "hasDiagram": false,
    "hasTable": false,
    "interviewQuestions": [
        {
