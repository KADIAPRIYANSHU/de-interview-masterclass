window.pythonLessons = {
    "1.1": {
        ...
        tableData: {
            ...
            headers: ["Structure", "Ordered", "Mutable", "Search Complexity"],
            rows: [
                ["List", "Yes", "Yes", "O(N) (linear search)"],
                ["Tuple", "Yes", "No", "O(N)"],
                ["Set", "No", "Yes", "O(1) (instant hash lookup)"],
                ["Dictionary", "Yes (3.7+)", "Yes", "O(1)"]
            ]
        },
        interviewQuestions: [
            {
    ...
    "2.3": {
        ...
        tableData: {
            ...
            headers: ["Operation Type", "Examples", "Does it trigger computation?"],
            rows: [
                ["Transformation", "filter(), select(), join(), groupBy()", "No (only builds execution plan)"],
                ["Action", "show(), collect(), count(), write()", "Yes (compiles and executes the DAG)"]
            ]
        },
        interviewQuestions: [
            {
